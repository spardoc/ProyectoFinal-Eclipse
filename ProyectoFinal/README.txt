...
a persistence unit "ProyectoFinalPersistenceUnit" which uses the JakartaEE default database.
...
The configuration can be found in "ProyectoFinal/pom.xml":
...
artifact ("ProyectoFinal.war") is already built. You can build
